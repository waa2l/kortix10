...
export default function AuthPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        // هذا الرابط سيعيدك للصفحة الرئيسية بعد الدخول
        // window.location.origin يأخذ الرابط الحالي سواء localhost أو vercel تلقائياً
    ...
    // ملاحظة: لن نحتاج لعمل setLoading(false) في حالة النجاح لأن المستخدم سيغادر الصفحة
  };
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden border border-slate-100">
        ...
        <div className="p-8">
          ...
          <button
            ...
            className="w-full bg-white border border-slate-200 text-slate-700 py-3 rounded-xl font-bold hover:bg-slate-50 transition flex items-center justify-center gap-3 mb-6 shadow-sm"
          >
            <GoogleIcon />
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-slate-500">أو باستخدام البريد</span>
            </div>
          </div>
            ...
            {!isLogin && (
              <>
                <div className="relative">
                  ...
                  <input 
                    type="text" placeholder="الاسم رباعي" required
